...
class Buddyfeesfirstfloorwrapper extends StatelessWidget {
  const Buddyfeesfirstfloorwrapper({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider<BuddyAuthBloc>(
      create: (context) => BuddyAuthBloc()
        ..add(FetchBuddyDetailsEvent(searchQuery: null, floor: "1st", )),
      child: Buddyfeesfirstfloor(),
    );
  }
}

class Buddyfeesfirstfloor extends StatefulWidget {
  const Buddyfeesfirstfloor({super.key});

  @override
  State<Buddyfeesfirstfloor> createState() => _BuddyfeesfirstfloorState();
}

class _BuddyfeesfirstfloorState extends State<Buddyfeesfirstfloor> {

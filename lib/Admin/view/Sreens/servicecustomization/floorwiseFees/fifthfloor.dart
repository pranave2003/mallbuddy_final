...
class Buddyfeesfifthfloorwrapper extends StatelessWidget {
  const Buddyfeesfifthfloorwrapper({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider<BuddyAuthBloc>(
      create: (context) => BuddyAuthBloc()
        ..add(FetchBuddyDetailsEvent(searchQuery: null,  floor: "Fifth Floor", Riderid: buddyid_global)),
      child: Buddyfeesfifthfloor(),
    );
  }
}

class Buddyfeesfifthfloor extends StatefulWidget {
  const Buddyfeesfifthfloor({super.key});

  @override
  State<Buddyfeesfifthfloor> createState() => _BuddyfeesfifthfloorState();
}

class _BuddyfeesfifthfloorState extends State<Buddyfeesfifthfloor> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      // appBar: AppBar(

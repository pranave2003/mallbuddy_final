...
class Buddyfeesgroundfloorwrapper extends StatelessWidget {
  const Buddyfeesgroundfloorwrapper({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider<BuddyAuthBloc>(
      create: (context) => BuddyAuthBloc()
        ..add(FetchBuddyDetailsEvent(searchQuery: null,
            floor: "GND",
      )),
      child: Buddyfeesgroundfloor(),
    );
  }
}

class Buddyfeesgroundfloor extends StatefulWidget {
  const Buddyfeesgroundfloor({super.key});

  @override
  State<Buddyfeesgroundfloor> createState() => _BuddyfeesgroundfloorState();
}

class _BuddyfeesgroundfloorState extends State<Buddyfeesgroundfloor> {

...
class BuddyfeesThirdfloorwrapper extends StatelessWidget {
  const BuddyfeesThirdfloorwrapper({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider<BuddyAuthBloc>(
      create: (context) => BuddyAuthBloc()
        ..add(FetchBuddyDetailsEvent(searchQuery: null,  floor: "3rd")),
      child: BuddyfeesThirdfloor(),
    );
  }
}

class BuddyfeesThirdfloor extends StatefulWidget {
  const BuddyfeesThirdfloor({super.key});

  @override
  State<BuddyfeesThirdfloor> createState() => _BuddyfeesThirdfloorState();
}

class _BuddyfeesThirdfloorState extends State<BuddyfeesThirdfloor> {
